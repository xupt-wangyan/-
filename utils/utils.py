...
class DecodeBox(nn.Module):
    ...
    def forward(self, input):
        ...
        FloatTensor = torch.FloatTensor.cuda() if x.is_cuda else torch.FloatTensor
        LongTensor = torch.LongTensor.cuda() if x.is_cuda else torch.LongTensor
